...
- **修改自 [mritd/shadowsocks](https://hub.docker.com/r/mritd/shadowsocks/)**
...
``` sh
docker run -dt --name ss -p 6443:6443 jingqian/shadowsockets -s "-s 0.0.0.0 -p 6443 -m chacha20 -k test123 --fast-open"
```
``` sh
docker run -dt --name ss -p 6443:6443 -e SS_PASSWORD=test123 jingqian/shadowsockets
```

``` sh
docker run -dt --name ss -p 6443:6443 -p 6500:6500 -e KCP_FLAG=true jingqian/shadowsockets
```
...
``` sh
docker run -dt --name ssserver -p 6443:6443 -p 6500:6500/udp jingqian/shadowsockets -m "ss-server" -s "-s 0.0.0.0 -p 6443 -m chacha20 -k test123 --fast-open" -x -e "kcpserver" -k "-t 127.0.0.1:6443 -l :6500 -mode fast2"
```
...
``` sh
docker run -dt --name ssclient -p 1080:1080 jingqian/shadowsockets -m "ss-local" -s "-s 127.0.0.1 -p 6500 -b 0.0.0.0 -l 1080 -m chacha20 -k test123 --fast-open" -x -e "kcpclient" -k "-r SSSERVER_IP:6500 -l :6500 -mode fast2"
```
...
``` sh
docker run -dt --name ss -p 6443:6443 -p 6500:6500/udp -e SS_CONFIG="-s 0.0.0.0 -p 6443 -m chacha20 -k test123 --fast-open" -e KCP_MODULE="kcpserver" -e KCP_CONFIG="-t 127.0.0.1:6443 -l :6500 -mode fast2" -e KCP_FLAG="true" jingqian/shadowsockets
```
